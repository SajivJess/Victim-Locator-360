...
#cap = cv2.VideoCapture('http://192.168.218.104:8080/video')

RTSP_URL = "rtsp://192.168.124.104:8080/h264_ulaw.sdp" 
#RTSP_URL = "rtsp://192.168.218.104:8080/avstream/channel=1/stream=1.sdp" 
...
@app.route('/live_feed')
def live_feed():
    ip_camera_url = "http://192.168.124.104:8080/video"  # Set your camera URL here
